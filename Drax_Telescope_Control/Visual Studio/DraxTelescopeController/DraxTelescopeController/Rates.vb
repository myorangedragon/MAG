...
'
' The Guid attribute sets the CLSID for ASCOM.DRAX.Telescope.Rate
' The ClassInterface/None attribute prevents an empty interface called
' _Rate from being created and used as the [default] interface
'
<Guid("91a2f93c-69ed-438b-a86c-85cfdaec22e6")>
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.DRAX.Telescope.AxisRates
' The ClassInterface/None attribute prevents an empty interface called
' _AxisRates from being created and used as the [default] interface
'
<Guid("99cfc7fd-73ff-462c-8e09-796a3dc420ac")>
<ClassInterface(ClassInterfaceType.None)>
<ComVisible(True)>
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.DRAX.Telescope.TrackingRates
' The ClassInterface/None attribute prevents an empty interface called
' _TrackingRates from being created and used as the [default] interface
'
<Guid("c7267e25-1486-483e-bf45-3fee6d97a2d7")>
<ClassInterface(ClassInterfaceType.None)>
<ComVisible(True)>
